        ...
        <section aria-label="Hero Image of the website" className="flow-root">
            <div className="rounded-2xl bg-slate-50/40 p-2 ring-1 ring-inset ring-slate-200/50 dark:bg-gray-900/70 dark:ring-white/10">
                <div className="rounded-xl bg-white ring-1 ring-slate-900/5 dark:bg-slate-950 dark:ring-white/15">
                    {/* Placeholder images - You should replace these with actual screenshots of your app */}
                    <ThemedImage
                        lightSrc="/favicon.ico"
                        darkSrc="/favicon.ico"
                        alt="App Preview"
                        width={2400}
                        height={1600}
                        className="rounded-xl shadow-2xl dark:shadow-indigo-600/10 object-cover h-[400px] w-full bg-gradient-to-br from-indigo-100 to-white dark:from-gray-900 dark:to-black"
                    />
                </div>
            </div>
        </section>
